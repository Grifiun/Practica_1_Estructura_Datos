...
void agregarCompraPorId(ListadoCliente* listado, int intAux){
    Cliente* nodoAux;
...
void generarListaCircularCompra(ListadoCliente* listado1, int idsUsados){
    int i = 0;
    ...
    while(i < cantidadClienteCompra){
        ...
        agregarCompraPorId(listado1, 1 + idsUsados + i);        
